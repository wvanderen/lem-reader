...
// Plan 16-02 Task 1 — the refusal-copy map + chunked base64 now live in
// ./ingestCopy (byte-identical extraction, pinned by the pdf/epub copy
// tests). IngestControl consumes them from there until Plan 16-03 retires
// this component.
