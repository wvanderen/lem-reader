# Spike 0009: Web Speech API word-boundary reality across browsers
...
**Numbering note:** researched and filed as spike 0008 on the `research/web-speech-word-boundaries` branch; the youtube-transcript spike landed on main with the 0008 number first (issue #20), so this doc merges as 0009. Findings are unchanged.
