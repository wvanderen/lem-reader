...
- [x] 20-03-PLAN.md — Dexie v6 assets store + atomic save/upsert/article/book cascade lifecycle (IMG-03, IMG-04)
...
- [x] 20-06-PLAN.md — EPUB container extraction retiring the D12-16 downgrade (IMG-01, IMG-02)
...
- [x] 21-03-PLAN.md — Highlights visible jump affordance + shared-token conformance with citation comments (POLISH-10)

**Wave 3** *(blocked on Wave 2 completion — D21-09 audit order)*

- [x] 21-04-PLAN.md — impeccable-informed five-dimension audit + blocker/major remediation + minors ledger (POLISH-11)
